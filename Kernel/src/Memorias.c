...
t_memoria* getMemoria(int numero){
	...
	t_memoria* resultado = malloc(sizeof(t_memoria));                                  //retorna si o no la encuentra, en caso de false vuelve a buscar hasta que sea true
	memcpy(resultado, memoria, sizeof(t_memoria));                                     //si la encuentra retorna un puntero ,si no retorna NULL.
